"""Read-only AAPL.X market and wallet observation. No transaction construction."""
...
MINT = 'u7i4awutsHa9qcy6YdDQKfjER16i9fx4PRhG4ZqUXZ5'
POOL = '4uX1ZyDNVAjpozzsuGMcaHJeSXfpB1TGrckHUkNkB2TX'
REFERENCE = 'apple-xstock'
...
def snapshot():
    ...
    seller.require(pool['baseToken']['address'] == MINT
                   ...
                   and pool['baseToken']['decimals'] == 8, 'Unexpected AAPL.X market')
    ...
    ref = fetch_reference(REFERENCE)[REFERENCE]
    ...
    seller.require(synced.tzinfo is not None, 'AAPL.X timestamp lacks timezone')
