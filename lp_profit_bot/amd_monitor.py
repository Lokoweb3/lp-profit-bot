"""Read-only AMD.X market and wallet observation. No transaction construction."""
...
MINT = "7Y5bai9oWEjZMYMkHxVBUzpUXJqAcwaHi8MptdcDhKk2"
POOL = "2DHp1qQsjBBhFZ5wupZNkBcs4U1HHKwCVAwqsDCJo46G"
...
def snapshot():
    ...
    seller.require(pool["baseToken"]["address"] == MINT
                   ...
                   and pool["baseToken"]["decimals"] == 8, "Unexpected AMD.X market")
    ...
    ref = fetch_reference("amd-xstock")["amd-xstock"]
    ...
    seller.require(synced.tzinfo is not None, "AMD.X timestamp lacks timezone")
