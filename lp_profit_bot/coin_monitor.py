"""Read-only COIN.X market and wallet observation. No transaction construction."""
...
MINT = "44QsUuVsKVGk5A1X5Vx7MnevsNe7UTVnijfkbSi3rtpY"
POOL = "FPvJx6U7qVhgCfaVigjEnVRgn7eHqcR4HMB7RarnhMsR"
...
def snapshot():
    ...
    seller.require(pool["baseToken"]["address"] == MINT
                   ...
                   and pool["baseToken"]["decimals"] == 8, "Unexpected COIN.X market")
    ...
    ref = fetch_reference("coinbase-xstock")["coinbase-xstock"]
    ...
    seller.require(synced.tzinfo is not None, "COIN.X timestamp lacks timezone")
