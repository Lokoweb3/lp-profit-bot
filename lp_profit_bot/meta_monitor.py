"""Read-only META.X market and wallet observation. No transaction construction."""
...
MINT = "36fxZScbKNXxAfJoiqk76egFGm5b7wWFutjJfXTU5nhT"
POOL = "Go77gHwGiCMiGuGYWcxvX6sfyQxJhJdbDcqvCbUX131v"
...
def snapshot():
    ...
    seller.require(pool["baseToken"]["address"] == MINT
                   ...
                   and pool["baseToken"]["decimals"] == 8, "Unexpected META.X market")
    ...
    ref = fetch_reference("meta-xstock")["meta-xstock"]
    ...
    seller.require(synced.tzinfo is not None, "META.X timestamp lacks timezone")
