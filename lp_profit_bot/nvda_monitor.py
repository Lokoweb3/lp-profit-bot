"""Read-only NVDA.X market and wallet observation. No transaction construction."""
...
MINT = "4JfDXUw8N7b1VJ1og1K3Nc4Z6nwtWxWJUSQKYBcdsiJz"
POOL = "7TnHuKQc5KEZPqp4NfrzARXpH9XfweVnjyzg1QL7nWs2"
...
def snapshot():
    ...
    seller.require(pool["baseToken"]["address"] == MINT
                   ...
                   and pool["baseToken"]["decimals"] == 8, "Unexpected NVDA.X market")
    ...
    ref = fetch_reference("nvidia-xstock")["nvidia-xstock"]
    ...
    seller.require(synced.tzinfo is not None, "NVDA.X timestamp lacks timezone")
