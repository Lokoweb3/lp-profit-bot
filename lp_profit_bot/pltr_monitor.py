"""Read-only PLTR.X market and wallet observation. No transaction construction."""
...
MINT = "2EPkJGy9C4CwdXFc7zpa4VxeansMRcRVdPnR52nBVZbW"
POOL = "13EhJs5rPcbhrjUBQP6wcxJMqvUrpVLszmu2S32w1VmG"
...
def snapshot():
    ...
    seller.require(pool["baseToken"]["address"] == MINT
                   ...
                   and pool["baseToken"]["decimals"] == 8, "Unexpected PLTR.X market")
    ...
    ref = fetch_reference("palantir-xstock")["palantir-xstock"]
    ...
    seller.require(synced.tzinfo is not None, "PLTR.X timestamp lacks timezone")
