"""Read-only SPY.X market and wallet observation. No transaction construction."""
...
MINT = "5Z7K1BaM36ubfNHkXbiDm5GW3KGzVSt3DFxD2b7p4VtJ"
POOL = "C7wzNxd8pa2roCidoP9WcZdnDPRV4TyAyqiotZQzrTFr"
...
def snapshot():
    ...
    seller.require(pool["baseToken"]["address"] == MINT
                   ...
                   and pool["baseToken"]["decimals"] == 8, "Unexpected SPY.X market")
    ...
    ref = fetch_reference("sp500-xstock")["sp500-xstock"]
    ...
    seller.require(synced.tzinfo is not None, "SPY.X timestamp lacks timezone")
