"""Read-only TSLA.X market and wallet observation. No transaction construction."""
...
MINT = "47wNUaHJyuiknQswU5qsfYKjaZ9ijueRB63ZrsxuRb4F"
POOL = "5Ur9GUzt6v9zjL3TSzveVDfZuZMLcfKCMMv9qodj9cZA"
...
def snapshot():
    ...
    seller.require(pool["baseToken"]["address"] == MINT
                   ...
                   and pool["baseToken"]["decimals"] == 8, "Unexpected TSLA.X market")
    ...
    ref = fetch_reference("tesla-xstock")["tesla-xstock"]
    ...
    seller.require(synced.tzinfo is not None, "TSLA.X timestamp lacks timezone")
