...
class DashboardHTTPTests(unittest.TestCase):
    ...
    def test_page_assets_and_status(self):
        ...
        self.assertIn(b'id="worker-purchase-badge"', page)
        self.assertIn(b'Action-bound confirmation', page)
        self.assertIn(b'Tracking cannot start another purchase', page)
